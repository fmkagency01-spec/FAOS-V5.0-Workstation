...
const ROLE_MODULES: Record<string, string[]> = {
  ...
  manager: [
    ...
    "command", "creative", "create-pillar", "ai-seo", "fmk-wig-b2b", "rr-wigs-workspace", "work-log", "learning-hub", "real-estate", "status",
  ],
  team_lead: [
  ...
  sales: ["home", "crm", "projects", "orders", "command", "work-log", "real-estate", "status"],
